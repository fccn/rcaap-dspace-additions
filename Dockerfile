# This file is based on DSpace Dockerfile

# This image will be published as rcaap/dspace
# See https://github.com/fccn/rcaap-dspace-additions for usage details
#
# - note: default tag for branch: rcaap/dspace: rcaap/dspace:latest
...
RUN chmod g+s /dspace /usr/local/tomcat
