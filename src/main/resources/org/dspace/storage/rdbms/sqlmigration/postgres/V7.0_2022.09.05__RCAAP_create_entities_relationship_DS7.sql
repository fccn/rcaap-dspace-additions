...
-- ver em V7.1_2024.04.19__RCAAP_Fix_MDV_place_after_DS7.sql
...
-- por causa do V7.1_2021.10.18__Fix_MDV_place_after_migrating_from_DSpace_5.sql
-- as relacoes do authorprofile serao eliminadas em V7.1_2024.04.19__RCAAP_Fix_MDV_place_after_DS7.sql