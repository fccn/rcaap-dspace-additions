...
/**
 * Try to look to an Item's bitstreams metadata for the corresponding author name and email.
 * Failover to the RequestItemSubmitterStrategy.
 *
 */
public class RequestItemBitstreamMetadataStrategy extends RequestItemSubmitterStrategy {
    ...
    public RequestItemBitstreamMetadataStrategy() {
    }
